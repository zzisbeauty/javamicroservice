 ...
 */
@Data
@TableName("daily_aggregation_info")
...
@ColumnWidth(25)
@Schema(title="Daily对象", description="日汇聚信息表")
public class Daily {
    ...
    @ExcelProperty("主键ID")
	private String id;
	/**汇聚时间（如 2025-01-06 00:00:00 表示当日，精确到秒）*/
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @Schema(description = "汇聚时间（如 2025-01-06 00:00:00 表示当日，精确到秒）")
    @NotEmpty(message = "汇聚时间（如 2025-01-06 00:00:00 表示当日，精确到秒）不能为空")
    @ExcelProperty("汇聚时间（如 2025-01-06 00:00:00 表示当日，精确到秒）")
	...
	/**最初值（日度内第一条记录的值）*/
    @Schema(description = "最初值（日度内第一条记录的值）")
    @NotEmpty(message = "最初值（日度内第一条记录的值）不能为空")
    @ExcelProperty("最初值（日度内第一条记录的值）")
	...
	/**最末值（日度内最后一条记录的值）*/
    @Schema(description = "最末值（日度内最后一条记录的值）")
    @NotEmpty(message = "最末值（日度内最后一条记录的值）不能为空")
    @ExcelProperty("最末值（日度内最后一条记录的值）")
