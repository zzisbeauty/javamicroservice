package com.hanwei.relation.service;
...
public interface IRelationService extends IService<Relation> {
     ...
     * @param relation
     */
    void exportData(ServletOutputStream outputStream, Map paramMap, Relation relation);
     ...
     * @return String
     */
    String exportDataToBase64(Map paramMap, Relation relation);
