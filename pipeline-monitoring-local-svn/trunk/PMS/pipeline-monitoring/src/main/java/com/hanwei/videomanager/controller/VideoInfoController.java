...
@Tag(name="视频信息")
@RestController
@RequestMapping("/videomanager/videoInfo")
public class VideoInfoController extends BaseController<VideoInfo, IVideoInfoService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "视频信息-分页列表查询")
	@Operation(summary="视频信息-分页列表查询")
	...
	public Result<?> queryById(@RequestParam(name="id",required=true) String id) {
	  ...
	  * @param fileName
	  */
	 @AutoLog(value = "视频信息-文件流导出")
	 @Operation(summary="视频信息-文件流导出")
	 @RequestMapping(value = "/exportXls", method = {RequestMethod.GET})
	 public Result<?> exportXls(HttpServletRequest request, HttpServletResponse response, VideoInfo videoInfo, String fileName){
		 try {
			 // 这里注意 使用swagger 会导致各种问题，请直接用浏览器或者用postman
			 response.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
			 response.setCharacterEncoding("utf-8");
			 // URLEncoder.encode可以防止中文乱码
			 fileName = URLEncoder.encode(Optional.ofNullable(fileName).orElse("视频信息"), "UTF-8").replaceAll("\\+", "%20");
	  ...
	  * @param videoInfo
	  */
	 @AutoLog(value = "视频信息-base64方式导出")
	 @Operation(summary="视频信息-base64方式导出")
	  ...
	  * @return
	  */
	 @AutoLog(value = "视频信息-excel文件导入")
	 @Operation(summary="视频信息-excel文件导入")
